...
exports.sleep = exports.textToTime = exports.timeToText = void 0;
class TimeUtils {
}
TimeUtils.timeToText = (time, pattern) => {
    const rules = {
...
TimeUtils.textToTime = (text, pattern) => {
...
TimeUtils.sleep = (milliseconds) => new Promise((resolve) => {
    setTimeout(resolve, milliseconds);
});
exports.default = TimeUtils;
exports.timeToText = TimeUtils.timeToText;
exports.textToTime = TimeUtils.textToTime;
exports.sleep = TimeUtils.sleep;
